...
def about_page():
    ...
    This application is designed to help readers, learners, and educators better understand the grammar and vocabulary used in English stories.
...
# To display this page in your Streamlit app, call about_page() from your main app script.
