...
translation = """
엠마는 어느 비 오는 오후, 다락방에서 오래된 나침반을 발견했습니다. 그것은 평범한 나침반이 아니었습니다—자기 북쪽이 아니라 사람의 가장 큰 욕망을 가리켰습니다. 엠마는 호기심에 이끌려 나침반이 가리키는 방향을 따라갔고, 전혀 새로운 방식으로 도시를 여행하게 되었습니다.
...
영감을 받은 엠마는 집으로 돌아가 첫 그림을 그리기 시작했고, 그 나침반은 이제 그녀의 가장 소중한 소지품이자 도시뿐 아니라 꿈을 향한 안내자가 되었습니다.
"""
